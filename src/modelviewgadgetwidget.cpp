    ...
    , vboEnable(false)
{
    ...
    setAcFilename(pathname+"/res/3D_Model/planes/firecracker/firecracker.3ds");
    setBgFilename(pathname+"/res/3D_Model/backgrounds/default_background.png");
    setVboEnable(true);
...
void ModelViewGadgetWidget::setAcFilename(QString acf)
{
    if (QFile::exists(acf)) {
        ...
        qDebug() << "file " << acf << " doesn't exists";
        acFilename = acf = "/home/galaxy/QtProjects/qt-serialport-tool-master/src/res/warning_sign.obj";
...
void ModelViewGadgetWidget::setBgFilename(QString bgf)
{
    if (QFile::exists(bgFilename)) {
        ...
        bgFilename = "/home/galaxy/QtProjects/qt-serialport-tool-master/src/res/black.jpg"; // will put a black background if there's no background
    }
}
...
void ModelViewGadgetWidget::CreateScene()
{
    ...
    if (acFilename == "/home/galaxy/QtProjects/qt-serialport-tool-master/src/res/warning_sign.obj" or !QFile::exists(bgFilename)) {
        bgFilename = "/home/galaxy/QtProjects/qt-serialport-tool-master/src/res/black.jpg";
    }
...
void ModelViewGadgetWidget::serialPortHandler(QByteArray array)
{
    memcpy(&attState,array,sizeof(AttitudeStateDataPacked));
    updateAttitude();
}
...
//////////////////////////////////////////////////////////////////////
/// \brief ModelViewGadgetWidget::updateAttitude
void ModelViewGadgetWidget::updateAttitude()
{
    GLC_StructOccurence *rootObject = m_World.rootOccurence(); // get the full 3D model
    double x = attState.q3;
    double y = attState.q2;
    double z = attState.q4;
    double w = attState.q1;
