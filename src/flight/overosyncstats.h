...
static inline void OveroSyncStatsLogging() { UAVObjLogging(OveroSyncStatsHandle()); }
static inline void OveroSyncStatsInstLogging(uint16_t instId) { UAVObjInstanceLogging(OveroSyncStatsHandle(), instId); }
