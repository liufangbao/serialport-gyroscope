...
void GLC_StlToWorld::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        {
            typedef void (GLC_StlToWorld::*_t)(int );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&GLC_StlToWorld::currentQuantum)) {
                *result = 0;
            }
        }
    }
...
const QMetaObject GLC_StlToWorld::staticMetaObject = {
    { &QObject::staticMetaObject, qt_meta_stringdata_GLC_StlToWorld.data,
      qt_meta_data_GLC_StlToWorld,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
