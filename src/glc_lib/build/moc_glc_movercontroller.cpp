...
void GLC_MoverController::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        {
            typedef void (GLC_MoverController::*_t)();
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&GLC_MoverController::repaintNeeded)) {
                *result = 0;
            }
        }
    }
...
const QMetaObject GLC_MoverController::staticMetaObject = {
    { &QObject::staticMetaObject, qt_meta_stringdata_GLC_MoverController.data,
      qt_meta_data_GLC_MoverController,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
